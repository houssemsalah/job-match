...
const StatCard = ({ title, value, icon, description, trend, trendValue, className, ...props }) => {
  return (
    <Card className={cn("", className)} {...props}>
      ...
      <CardContent>
        ...
        {trend && (
          <div className={cn("mt-2 flex items-center text-xs", trend === "up" ? "text-green-500" : "text-red-500")}>
            {trend === "up" ? (
